...
export default function ActivityDashboard({activities, selectedActivity, SelectActivity, CancelSelectedActivity, editMode, formOpen, formClose, CreateOrEdit, deleteActivity }: Props) {
    return (
        <Grid>
